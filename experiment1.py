...
def simulate_response_latency():
    """
    Simulates application/API response latency.
    Later this can be replaced with real API health checks.
    """
...
def collect_metrics():
    ...
    metrics = {
        ...
        "response_latency_ms": simulate_response_latency()
    }
...
def print_metrics(metrics):
    ...
    print(f"Response Latency    : {metrics['response_latency_ms']:.2f} ms")
